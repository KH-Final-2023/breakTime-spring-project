 ...
 */
 ...
 chattingSock.onmessage = function(e){
	...
	// 전달받은 메세지를 JS객체로 변환
	const chatMessageBu = JSON.parse(e.data); // JSON -> JS Object
	console.log(chatMessageBu);
	...
	p.innerHTML = chatMessageBu.message.replace( /\\n/gm , "<br>" );
	//내용
	...
	// 내가 쓴 채팅 : span -> p
	// 남이 쓴 채팅 : p -> span
	if( buNo == chatMessageBu.buNo ) { // 내가쓴거
	
		li.append(span , p);
		li.classList.add("myChat");
	} else { // 남이쓴거
		li.innerHTML = "<b>" + chatMessageBu.buNo + "</b><br>";
		li.append(p, span);
	}
